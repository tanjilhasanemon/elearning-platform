<?php
// Courses Page - ENHANCED VERSION
// This page displays all available courses with category filtering
// Includes proper image handling with fallback
 ...
 * @param string $thumbnail - The thumbnail filename from database
 * @param string $path_prefix - The path prefix (from header.php)
 * @param string $default - The default image filename
                        ...
                        <?php foreach ($courses as $course): ?>
                            <div class="course-card">
                                <div class="course-image">
                                    <!-- ENHANCED: Shows thumbnail, or default image if not available -->
                                    <img 
